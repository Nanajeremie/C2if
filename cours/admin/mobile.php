<div class="header-advance-area">
    <div class="header-top-area ">
        <div class="container-fluid primeBack">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="header-top-wraper ">
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-md-12 col-sm-11 text-right">
                                <div class="header-right-info">
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu d-inline">
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a href="lock.php">Verouiller <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
